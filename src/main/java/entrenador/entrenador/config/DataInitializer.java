...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        entrenadorRepository.save(new Entrenador(null,"19.482.021-0", "Guillermo Salas", new Date(1980,12,10)));
        entrenadorRepository.save(new Entrenador(null,"20.493.492-1", "Marcelo Donal", new Date(2001,1,16)));
        entrenadorRepository.save(new Entrenador(null,"19.902.142-k","Juan Perez", new Date(1990, 9, 21)));
        entrenadorRepository.save(new Entrenador(null,"21.901.389-2","Cristofer Cifuentes", new Date(2005,7,28)));
